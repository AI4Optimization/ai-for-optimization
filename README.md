...
| [Tight lower bound for discrete minimax optimization](projects/dmo-equalization-lower-bound/) | Deterministic first-order discrete minimax optimization | $\Omega(N\Delta L/\epsilon^2)$ component-oracle calls | Verified draft; not yet written up |
