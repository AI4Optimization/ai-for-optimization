# Tight complexity bounds for minimax optimization under PL conditions

## Status

**Partially solved.** Pan and Li (2026) resolve the one-sided nonconvex--PL case; the two-sided PL--PL lower bound remains open.
...
The one-sided NC--PL upper bound is $O(\kappa_y\epsilon^{-2})$ and now has a matching lower bound. The PL--PL upper bound is $\widetilde O(\kappa_x\kappa_y)$. Prove a matching two-sided lower bound, up to logarithmic factors, under the same oracle and regularity assumptions.
...
- [Pan and Li, matching one-sided PL lower bounds (2026)](https://arxiv.org/abs/2608.26799)
